    ...
    <section className={className}>
      <div className="rounded-xl border border-sky-200 bg-sky-50 px-3 py-3 text-sm text-sky-900 sm:px-4">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              {resumableState.orders.map((order) => (
                <li key={order.orderId} className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-sky-200 bg-white px-2.5 py-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <Link href={order.href} className="cx-btn-secondary px-2.5 py-1 text-xs">
        ...
        {resumableState.checkoutHref ? (
          <div className={resumableState.orders.length > 0 ? "mt-3 border-t border-sky-200 pt-3" : ""}>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <Link href={resumableState.checkoutHref} className="cx-btn-secondary px-3 py-1.5 text-xs">
                Retomar checkout
              </Link>
              <button
                type="button"
